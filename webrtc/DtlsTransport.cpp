...
// 修复 OpenSSL 1.1/3.0 以上版本将 BIO_eof 变为宏导致旧代码链接失败的问题
extern "C" int BIO_eof(BIO *b) {
    return (int)(BIO_ctrl(b, BIO_CTRL_INFO, 0, NULL) == 1);
}
using namespace std;
...
namespace RTC
{
    ...
    void DtlsTransport::DtlsEnvironment::GenerateCertificateAndPrivateKey()
    {
        ...
        certName = (X509_NAME *)X509_get_subject_name(certificate);
